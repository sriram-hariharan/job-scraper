...
# Step 18D22 per-scheduler automation control and protected-guard
# reconciliation. Exact paths only; generated bundles are named explicitly and
# runtime marker scanning remains mandatory.
