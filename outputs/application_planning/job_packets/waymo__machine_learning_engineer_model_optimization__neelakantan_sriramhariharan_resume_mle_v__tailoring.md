...
**Job:** waymo | Machine Learning Engineer, Model Optimization
**Selected resume:** Neelakantan_SriramHariharan_Resume_MLE_v3.pdf
**Selected score:** 0.617

## Recruiter Summary
Neelakantan_SriramHariharan_Resume_MLE_v3.pdf is the selected variant for waymo | Machine Learning Engineer, Model Optimization with a deterministic score of 0.617. It already aligns on machine learning, python, pytorch. The main explicit gaps still showing are computer vision, jax.
...
Job company: waymo
Job title: Machine Learning Engineer, Model Optimization
Selected resume: Neelakantan_SriramHariharan_Resume_MLE_v3.pdf
Selected score: 0.617
...
Top dimensions: required_skills_alignment=0.60/0.153, title_alignment=0.66/0.138, analytics_ml_depth=1.00/0.116, tooling_alignment=1.00/0.093, domain_relevance=0.50/0.047, experimentation_depth=0.50/0.047
