...
**Job:** samsara | AI Engineer
**Selected resume:** Sriram_Neelakantan_AI1.pdf
**Selected score:** 0.605

## Recruiter Summary
Sriram_Neelakantan_AI1.pdf is the selected variant for samsara | AI Engineer with a deterministic score of 0.605. It already aligns on python, pytorch, sql, tensorflow. The main explicit gaps still showing are artificial intelligence, docker, git, kubernetes.

## Keep / Emphasize
- Keep explicit required-skill evidence visible: python, pytorch, sql, tensorflow.
- Preserve the strongest JD-aligned language already present: ai engineer, python, pytorch, sql, tensorflow.

## Tailoring Actions
- Move the strongest already-supported required skills higher in the resume or summary: python, pytorch, sql, tensorflow.
- Reuse or strengthen bullets that already prove these JD-aligned terms: python, sql.
- Review whether you have truthful evidence for the missing required skills before editing anything: artificial intelligence, docker, git, kubernetes.
...
## Do Not Claim
- Do not claim missing required skills unless you can support them truthfully: artificial intelligence, docker, git, kubernetes.
- Do not add unsupported preferred-skill claims: apis, data platforms, domain-specific business applications, enterprise systems, genai, saastransactions.
...
Matched required skills: ['python', 'pytorch', 'sql', 'tensorflow']
Missing required skills: ['artificial intelligence', 'docker', 'git', 'kubernetes']
Matched preferred skills: []
Missing preferred skills: ['apis', 'data platforms', 'domain-specific business applications', 'enterprise systems', 'genai', 'saastransactions']
Matched terms: ['ai engineer', 'python', 'pytorch', 'sql', 'tensorflow']
Top dimensions: title_alignment=1.00/0.209, required_skills_alignment=0.50/0.128, tooling_alignment=1.00/0.093, analytics_ml_depth=0.50/0.058, domain_relevance=0.50/0.047, experimentation_depth=0.50/0.047

Best existing bullets to reuse/review:
1. [experience] Data Analyst I @ Accenture | overlaps=['python', 'sql'] | bullet=Manipulated and analyzed large-scale clinical and real-world datasets (trial records, biomarker studies) using Python, SQL, and Databricks, ensuring compliance with regulatory standards, improving early risk detection 10%
2. [experience] Data Analyst II @ Accenture | overlaps=['python', 'sql'] | bullet=Conducted portfolio exposure analysis using Python for scenario modeling, SQL for data aggregation, & Tableau for risk visualization, informing pricing and design changes that improved profitability by 10% and reduced lapse risk by 12%
