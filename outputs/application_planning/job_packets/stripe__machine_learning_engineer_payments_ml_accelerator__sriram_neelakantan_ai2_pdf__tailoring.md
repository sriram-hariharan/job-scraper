...
- Preserve the strongest JD-aligned language already present: deep learning, python, spark.

## Tailoring Actions
- Move the strongest already-supported required skills higher in the resume or summary: deep learning, python, spark.
- Reuse or strengthen bullets that already prove these JD-aligned terms: python, spark.
- Review whether you have truthful evidence for the missing required skills before editing anything: llm/foundation models, scala.
