...
**Job:** pinterest | Data Scientist II, Growth Marketing
**Selected resume:** Sriram_Neelakantan_AI2.pdf
**Selected score:** 0.634

## Recruiter Summary
Sriram_Neelakantan_AI2.pdf is the selected variant for pinterest | Data Scientist II, Growth Marketing with a deterministic score of 0.634. It already aligns on causal inference, machine learning, python, r, sql. The main explicit gaps still showing are etl, experimentation, hive, statistics.

## Keep / Emphasize
- Keep explicit required-skill evidence visible: causal inference, machine learning, python, r, sql.
- Preserve the strongest JD-aligned language already present: Sr. Data Scientist, causal inference, experimentation, machine learning, python, r, sql.

## Tailoring Actions
- Move the strongest already-supported required skills higher in the resume or summary: causal inference, machine learning, python, r, sql.
- Reuse or strengthen bullets that already prove these JD-aligned terms: python, sql.
- Review whether you have truthful evidence for the missing required skills before editing anything: etl, experimentation, hive, statistics.
...
## Do Not Claim
- Do not claim missing required skills unless you can support them truthfully: etl, experimentation, hive, statistics.
...
Job title: Data Scientist II, Growth Marketing
Selected resume: Sriram_Neelakantan_AI2.pdf
Selected score: 0.634

Matched required skills: ['causal inference', 'machine learning', 'python', 'r', 'sql']
Missing required skills: ['etl', 'experimentation', 'hive', 'statistics']
Matched preferred skills: []
Missing preferred skills: []
Matched terms: ['Sr. Data Scientist', 'causal inference', 'experimentation', 'machine learning', 'python', 'r', 'sql']
Top dimensions: required_skills_alignment=0.67/0.171, title_alignment=0.59/0.123, tooling_alignment=1.00/0.093, analytics_ml_depth=0.60/0.070, experimentation_depth=0.67/0.062, domain_relevance=0.50/0.047
