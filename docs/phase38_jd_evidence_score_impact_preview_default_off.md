...
Phase 38A adds the JD evidence score impact preview. This is a capability step on the revised path. It is not another safety-wrapper chain.

The helper performs deterministic score impact preview. It converts advisory contribution previews into hypothetical score impact previews and produces hypothetical score preview values. It preserves existing score fields.
