...
**Job:** waymo | Senior Applied Research Scientist, Perception
**Selected resume:** Sriram_Neelakantan_General_Data_Scientist.pdf
**Selected score:** 0.555

## Recruiter Summary
Sriram_Neelakantan_General_Data_Scientist.pdf is the selected variant for waymo | Senior Applied Research Scientist, Perception with a deterministic score of 0.555. It already aligns on machine learning, python, pytorch. The main explicit gaps still showing are computer vision, jax.
...
Job company: waymo
Job title: Senior Applied Research Scientist, Perception
Selected resume: Sriram_Neelakantan_General_Data_Scientist.pdf
Selected score: 0.555
...
Top dimensions: required_skills_alignment=0.60/0.153, analytics_ml_depth=1.00/0.116, tooling_alignment=1.00/0.093, title_alignment=0.36/0.076, domain_relevance=0.50/0.047, experimentation_depth=0.50/0.047
