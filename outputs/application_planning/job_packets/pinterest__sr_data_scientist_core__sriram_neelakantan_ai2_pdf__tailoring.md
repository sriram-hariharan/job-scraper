...
**Job:** pinterest | Sr. Data Scientist, Core
**Selected resume:** Sriram_Neelakantan_AI2.pdf
**Selected score:** 0.730

## Recruiter Summary
Sriram_Neelakantan_AI2.pdf is the selected variant for pinterest | Sr. Data Scientist, Core with a deterministic score of 0.730. It already aligns on python, pytorch, r, scikit-learn, sql, tensorflow. The main explicit gaps still showing are python or r.

## Keep / Emphasize
- Keep explicit required-skill evidence visible: python, pytorch, r, scikit-learn, sql, tensorflow.
- Preserve the strongest JD-aligned language already present: Sr. Data Scientist, python, pytorch, r, scikit-learn, sql, tensorflow.

## Tailoring Actions
- Move the strongest already-supported required skills higher in the resume or summary: python, pytorch, r, scikit-learn, sql, tensorflow.
- Reuse or strengthen bullets that already prove these JD-aligned terms: python, sql.
- Review whether you have truthful evidence for the missing required skills before editing anything: python or r.
...
## Do Not Claim
- Do not claim missing required skills unless you can support them truthfully: python or r.
...
Job title: Sr. Data Scientist, Core
Selected resume: Sriram_Neelakantan_AI2.pdf
Selected score: 0.730

Matched required skills: ['python', 'pytorch', 'r', 'scikit-learn', 'sql', 'tensorflow']
Missing required skills: ['python or r']
Matched preferred skills: []
Missing preferred skills: []
Matched terms: ['Sr. Data Scientist', 'python', 'pytorch', 'r', 'scikit-learn', 'sql', 'tensorflow']
Top dimensions: required_skills_alignment=0.86/0.219, title_alignment=0.72/0.150, experimentation_depth=1.00/0.093, tooling_alignment=1.00/0.093, analytics_ml_depth=0.50/0.058, domain_relevance=0.50/0.047
