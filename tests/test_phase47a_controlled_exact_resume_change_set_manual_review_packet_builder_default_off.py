...
def test_changed_files_are_limited_to_phase47a_and_legacy_guard_tests():
    ...
    legacy_guards = {
        ...
        if "controlled_exact_resume_change_set_manual_review_packet_builder_default_off" in path.read_text(
            encoding="utf-8"
        )
        or "phase47_controlled_exact_resume_change_set_manual_review_packet_builder_default_off"
