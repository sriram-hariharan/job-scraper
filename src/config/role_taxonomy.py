...
ROLE_TAXONOMY: Dict[str, Dict[str, Any]] = {
    ...
    "ml_ai_engineering": {
        ...
        "title_include_patterns": (
            ...
            r"machine learning enginer",
            r"\bml engineer\b",
            r"\bml enginer\b",
            r"ai engineer",
            r"ai content engineer",
            ...
            r"applied ai inference engineer",
            r"audio inference engineer",
            r"inference engineer",
            r"deep learning engineer",
            r"nlp engineer",
            r"research engineer",
            r"research engineer scientist",
            r"ml research resident",
            r"machine learning research scientist",
    ...
    "cloud_devops": {
        ...
        "title_include_patterns": (
            ...
            r"infra engineer",
            r"engineer infra",
            r"infrastructure deployment engineer",
            r"infrastructure ops engineer",
    ...
    "security": {
        ...
        "title_include_patterns": (
            ...
            r"ai security specialist",
            r"security operations engineer",
            r"security analyst",
        ),
        "title_exclude_patterns": COMMON_TITLE_EXCLUDE_PATTERNS,
        "skill_patterns": (
