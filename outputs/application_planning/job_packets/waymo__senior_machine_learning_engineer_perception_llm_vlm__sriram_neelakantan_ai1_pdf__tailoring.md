...
**Job:** waymo | Senior Machine Learning Engineer, Perception LLM/VLM
**Selected resume:** Sriram_Neelakantan_AI1.pdf
**Selected score:** 0.565

## Recruiter Summary
Sriram_Neelakantan_AI1.pdf is the selected variant for waymo | Senior Machine Learning Engineer, Perception LLM/VLM with a deterministic score of 0.565. It already aligns on machine learning, python, pytorch, tensorflow. The main explicit gaps still showing are continual learning, jax, large scale datasets, large-scale model development.
...
- Review whether you have truthful evidence for the missing required skills before editing anything: continual learning, jax, large scale datasets, large-scale model development, model training.
...
## Do Not Claim
- Do not claim missing required skills unless you can support them truthfully: continual learning, jax, large scale datasets, large-scale model development, model training.
- Do not add unsupported preferred-skill claims: autonomous vehicle perception, decision-making systems, fine-tuning, large-scale data curation, motion planning.
...
Job company: waymo
Job title: Senior Machine Learning Engineer, Perception LLM/VLM
Selected resume: Sriram_Neelakantan_AI1.pdf
Selected score: 0.565

Matched required skills: ['machine learning', 'python', 'pytorch', 'tensorflow']
Missing required skills: ['continual learning', 'jax', 'large scale datasets', 'large-scale model development', 'model training']
Matched preferred skills: []
Missing preferred skills: ['autonomous vehicle perception', 'decision-making systems', 'fine-tuning', 'large-scale data curation', 'motion planning']
Matched terms: ['machine learning', 'python', 'pytorch', 'tensorflow']
Top dimensions: title_alignment=0.60/0.126, analytics_ml_depth=1.00/0.116, required_skills_alignment=0.44/0.114, tooling_alignment=1.00/0.093, domain_relevance=0.50/0.047, experimentation_depth=0.50/0.047
