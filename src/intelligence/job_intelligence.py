...
def build_job_intelligence(job):
    ...
    # ---------------------------------------------------
    # LLM ENRICHMENT (only if regex extraction weak)
    # ---------------------------------------------------
    ...
    if needs_llm_skill_enrichment(required_skills):
        ...
        # If LLM returned skills, trust them
        if llm_required:
            required_skills = list(set(llm_required))
        else:
            required_skills = list(set(required_skills))

        preferred_skills = list(set(preferred_skills + llm_preferred))
