...
def test_no_new_runtime_provider_execution_or_submission_markers():
    ...
    runtime_changes = [
        ...
        and path != "src/evaluation/controlled_production_parity_benchmark.py"
        ...
        and path != "src/app/applied_ui.py"
        and path != "src/app/intelligence_ui.py"
        and path != "src/app/saved_ui.py"
        and path != "src/app/static/intelligence.js"
        and path != "src/agents/manual_generate_ai_tailoring_preview_contract.py"
        and path != "src/agents/manual_provider_preview_production_task_contract.py"
