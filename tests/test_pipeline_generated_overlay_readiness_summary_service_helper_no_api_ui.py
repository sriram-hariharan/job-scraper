...
def test_service_helper_does_not_add_api_route_or_ui_action():
    ...
    assert HELPER_NAME not in api_source
    assert HELPER_NAME not in ui_source
    assert "pipeline-generated-overlay-readiness-summary" not in api_source
