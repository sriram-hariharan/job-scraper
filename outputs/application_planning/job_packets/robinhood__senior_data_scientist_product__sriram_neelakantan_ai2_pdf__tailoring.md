...
**Job:** robinhood | Senior Data Scientist, Product
**Selected resume:** Sriram_Neelakantan_AI2.pdf
**Selected score:** 0.618

## Recruiter Summary
Sriram_Neelakantan_AI2.pdf is the selected variant for robinhood | Senior Data Scientist, Product with a deterministic score of 0.618. It already aligns on machine learning, python, sql. The main explicit gaps still showing are causal inference analysis, data-informed strategy, predictive models, scalable dashboards.

## Keep / Emphasize
- Keep explicit required-skill evidence visible: machine learning, python, sql.
- Preserve the strongest JD-aligned language already present: Sr. Data Scientist, machine learning, python, sql.

## Tailoring Actions
- Move the strongest already-supported required skills higher in the resume or summary: machine learning, python, sql.
- Reuse or strengthen bullets that already prove these JD-aligned terms: python, sql.
- Review whether you have truthful evidence for the missing required skills before editing anything: causal inference analysis, data-informed strategy, predictive models, scalable dashboards, statistical analysis.
...
## Do Not Claim
- Do not claim missing required skills unless you can support them truthfully: causal inference analysis, data-informed strategy, predictive models, scalable dashboards, statistical analysis.
...
Job title: Senior Data Scientist, Product
Selected resume: Sriram_Neelakantan_AI2.pdf
Selected score: 0.618

Matched required skills: ['machine learning', 'python', 'sql']
Missing required skills: ['causal inference analysis', 'data-informed strategy', 'predictive models', 'scalable dashboards', 'statistical analysis']
Matched preferred skills: []
Missing preferred skills: []
Matched terms: ['Sr. Data Scientist', 'machine learning', 'python', 'sql']
Top dimensions: title_alignment=0.72/0.150, required_skills_alignment=0.38/0.096, experimentation_depth=1.00/0.093, tooling_alignment=1.00/0.093, analytics_ml_depth=0.60/0.070, domain_relevance=0.50/0.047
