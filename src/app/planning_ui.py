...
<head>
  ...
  <link rel="stylesheet" href="/static/scan_workspace.css?v=scan_workspace_phase10_4" />
</head>
<body>
{render_top_shell("/scan-workspace")}
  ...
  <script src="/static/shell.js"></script>
  <script src="/static/planning.js?v=planning_ui_20260429_scan_d2b"></script>
  <script src="/static/scan_workspace.js?v=scan_workspace_phase10_4"></script>
</body>
</html>
    """.strip()