...
**Job:** andurilindustries | Senior Machine Learning Engineer, Image Processing
**Selected resume:** Neelakantan_SriramHariharan_Resume_MLE_v3.pdf
**Selected score:** 0.668

## Recruiter Summary
Neelakantan_SriramHariharan_Resume_MLE_v3.pdf is the selected variant for andurilindustries | Senior Machine Learning Engineer, Image Processing with a deterministic score of 0.668. It already aligns on deep learning, machine learning, python, pytorch. The main explicit gaps still showing are image processing.

## Keep / Emphasize
- Keep explicit required-skill evidence visible: deep learning, machine learning, python, pytorch.
- Preserve the strongest JD-aligned language already present: machine learning engineer, deep learning, machine learning, python, pytorch.

## Tailoring Actions
- Move the strongest already-supported required skills higher in the resume or summary: deep learning, machine learning, python, pytorch.
- Reuse or strengthen bullets that already prove these JD-aligned terms: machine learning, python, validation, pytorch.
- Review whether you have truthful evidence for the missing required skills before editing anything: image processing.
...
## Do Not Claim
- Do not claim missing required skills unless you can support them truthfully: image processing.
- Do not add unsupported preferred-skill claims: classical techniques, computer vision, data preparation, deployment, model training, validation.
...
- **[experience] Data Scientist II @ L.B. Foster Salient Systems** | overlaps=['validation']
  - Automated ADC-based sensor data validation across 16 circuits per rail enhances electronic signal integrity and strengthens anomaly isolation and wheel health diagnostics by reducing misclassification by 40%.
  - Reuse/review this bullet because it already supports: validation
...
Job company: andurilindustries
Job title: Senior Machine Learning Engineer, Image Processing
Selected resume: Neelakantan_SriramHariharan_Resume_MLE_v3.pdf
Selected score: 0.668

Matched required skills: ['deep learning', 'machine learning', 'python', 'pytorch']
Missing required skills: ['image processing']
Matched preferred skills: []
Missing preferred skills: ['classical techniques', 'computer vision', 'data preparation', 'deployment', 'model training', 'validation']
Matched terms: ['machine learning engineer', 'deep learning', 'machine learning', 'python', 'pytorch']
Top dimensions: required_skills_alignment=0.80/0.205, title_alignment=0.66/0.138, analytics_ml_depth=1.00/0.116, tooling_alignment=1.00/0.093, domain_relevance=0.50/0.047, experimentation_depth=0.50/0.047
...
3. [experience] Data Scientist II @ L.B. Foster Salient Systems | overlaps=['validation'] | bullet=Automated ADC-based sensor data validation across 16 circuits per rail enhances electronic signal integrity and strengthens anomaly isolation and wheel health diagnostics by reducing misclassification by 40%.
