...
def test_dependency_files_match_phase8i_checkpoint():
    ...
    assert _aggregate_hash(paths) in {
        ...
        # Approved dependency cleanup (3f84e381) removed pandas, openpyxl
        # and schedule. Nothing was added; pgvector is still absent.
        "90e9a401af344c0c7f7a7d23feb10b1ac36013263d96d5132caca3a42350c571",
    }
