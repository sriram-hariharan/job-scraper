...
def applied_jobs_dashboard() -> str:
    return f"""
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <div class="page">
    <header class="page-header">
      <div>
        <h1>Applied Jobs</h1>
        <p class="subtext">Jobs you have marked as applied.</p>
      </div>
    </header>

    <section class="card controls-card" id="applicationViewRoot"
      data-endpoint="/applied-jobs"
      data-page-label="Applied Jobs"
      data-empty-label="No applied jobs yet.">
      <div class="controls-row">
        ...
        <div class="control-group">
          ...
          <input type="number" id="applicationLimitInput" value="15" min="1" max="300" />
        </div>
