...
<head>
  ...
  <link rel="stylesheet" href="/static/scan_workspace.css?v=scan_workspace_phase10_7" />
</head>
<body>
{render_top_shell("/scan-workspace")}
  ...
  <script src="/static/shell.js"></script>
  <script src="/static/planning.js?v=planning_ui_20260429_scan_d4"></script>
  <script src="/static/scan_workspace.js?v=scan_workspace_phase10_7"></script>
</body>
</html>
    """.strip()