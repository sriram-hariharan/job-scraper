...
**Job:** boxinc | Senior Machine Learning Engineer, Shield
**Selected resume:** Sriram_Neelakantan_AI1.pdf
**Selected score:** 0.507

## Recruiter Summary
Sriram_Neelakantan_AI1.pdf is the selected variant for boxinc | Senior Machine Learning Engineer, Shield with a deterministic score of 0.507. It already aligns on core requirements. The main explicit gaps still showing are aws sagemaker, azure machine learning.

## Keep / Emphasize
- Keep preferred-skill evidence visible: python, pytorch, tensorflow.
...
- Review whether you have truthful evidence for the missing required skills before editing anything: aws sagemaker, azure machine learning.
...
## Do Not Claim
- Do not claim missing required skills unless you can support them truthfully: aws sagemaker, azure machine learning.
- Do not add unsupported preferred-skill claims: apache spark, gcp, go, java, kubernetes.
...
Job company: boxinc
Job title: Senior Machine Learning Engineer, Shield
Selected resume: Sriram_Neelakantan_AI1.pdf
Selected score: 0.507

Matched required skills: []
Missing required skills: ['aws sagemaker', 'azure machine learning']
Matched preferred skills: ['python', 'pytorch', 'tensorflow']
Missing preferred skills: ['apache spark', 'gcp', 'go', 'java', 'kubernetes']
Matched terms: ['machine learning', 'python', 'pytorch', 'tensorflow']
Top dimensions: title_alignment=0.70/0.147, analytics_ml_depth=1.00/0.116, tooling_alignment=1.00/0.093, domain_relevance=0.50/0.047, experimentation_depth=0.50/0.047, preferred_skills_alignment=0.38/0.035
