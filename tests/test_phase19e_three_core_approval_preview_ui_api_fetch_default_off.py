...
def test_api_result_reuses_existing_phase19d_renderer():
    ...
    assert "withThreeCoreApprovalPreviewServiceReadbackApiFetch({" in source
    assert "...tracePayload" in source
    assert "evidence_chain_trace_readback: evidenceChainPayload" in source
